import type{Customer,FarmProduction,OperationalCost,ProductionBatch,RawEggTransaction,Sale,SaltedEggTransaction,Settings,StockState,Supplier}from'@/shared/types';
