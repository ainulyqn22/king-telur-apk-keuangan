...
} from "../domain/ProductionBatchRepository";
...
export class ProductionBatchService {
  ...
  create(command: CreateProductionBatchCommand) {
    return this.repository.create(schema.parse(command));
  }
  transition(id: string, status: BatchStatus) {
